...
<body>
	<dad2:control>
		<div class="w3-container w3-center w3-animate-opacity">
			<h3>Listado usarios</h3>
			<br>

			<%
				Hashtable<String, User> users = ((Hashtable<String, User>) request.getServletContext()
							.getAttribute("USERS"));
			%>
			...
			<table class="w3-table-all">
				...
				<tr>
					...
					<td><%=user.getRol()%></td>
					<td><a id="update"
						href="Control?ACTION_ID=UPDATEUSER&NAME=<%=user.getName()%>">Actualizar
					</a></td>
					<td><a
						href="Control?ACTION_ID=DELETEUSER&NAME=<%=user.getName()%>">Borrar
					</a></td>
				</tr>
