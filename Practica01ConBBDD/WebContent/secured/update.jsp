...
<body>
	...
	<br>
		...
		<form action="Control?ACTION_ID=UPDATEUSER" method="post" class="container">
			<input type="hidden" name="UPDATEOK" value="ok">
			Id: <input type="text" name="ID" value="${ ID }" readonly="readonly" class="form-control"><br>
			Nombre:<input type="text" name="NAME" value="${ UPNAME }" class="form-control"><br>
