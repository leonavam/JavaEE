...
<body>
	<dad2:control>
		...
		<form action="Control?ACTION_ID=UPDATECURSO" method="post"
			...
			<div class="form-group">
				Nombre Curso:<input type="text" name="NAMECURSO" value="${ UPNAME }"
					readonly="readonly" class="form-control">
			</div>
			<div class="form-group">
				Creditos:<input type="number" name="CREDITOS" required min="3"
					max="15" step="0.5" class="form-control">
			</div>
			<div class="form-group">
				Profesor:<input type="text" name="PROFESOR" required
					class="form-control">
			</div>
